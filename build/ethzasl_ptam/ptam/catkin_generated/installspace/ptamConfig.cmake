...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ptam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sun/catkin_ws/install/${idir}'.  Ask the maintainer 'Markus Achtelik <markus.achtelik@mavt.ethz.ch>, Stephan Weiss <stephan.weiss@mavt.ethz.ch>, Simon Lynen <simon.lynen@mavt.ethz.ch>' to fix it.")
    endif()
