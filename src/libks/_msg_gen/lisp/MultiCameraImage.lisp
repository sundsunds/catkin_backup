...
(cl:defmethod cl:initialize-instance :after ((m <MultiCameraImage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MultiCameraImage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name libks-msg:<MultiCameraImage> is deprecated: use libks-msg:MultiCameraImage instead.")))
...
(cl:defmethod cam0-val ((m <MultiCameraImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader libks-msg:cam0-val is deprecated.  Use libks-msg:cam0 instead.")
  (cam0 m))

(cl:ensure-generic-function 'cam1-val :lambda-list '(m))
(cl:defmethod cam1-val ((m <MultiCameraImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader libks-msg:cam1-val is deprecated.  Use libks-msg:cam1 instead.")
  (cam1 m))

(cl:ensure-generic-function 'cam2-val :lambda-list '(m))
(cl:defmethod cam2-val ((m <MultiCameraImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader libks-msg:cam2-val is deprecated.  Use libks-msg:cam2 instead.")
  (cam2 m))

(cl:ensure-generic-function 'cam3-val :lambda-list '(m))
(cl:defmethod cam3-val ((m <MultiCameraImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader libks-msg:cam3-val is deprecated.  Use libks-msg:cam3 instead.")
  (cam3 m))
