...
(cl:defmethod cl:initialize-instance :after ((m <ImageSet>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageSet)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name libks-msg:<ImageSet> is deprecated: use libks-msg:ImageSet instead.")))
...
(cl:defmethod images-val ((m <ImageSet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader libks-msg:images-val is deprecated.  Use libks-msg:images instead.")
  (images m))
