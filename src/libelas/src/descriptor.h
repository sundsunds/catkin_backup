...
public:
  ...
  Descriptor(uint8_t* I,int32_t width,int32_t height,int32_t bpl,int subsampling_step);
...
private:
  ...
  void createDescriptor(uint8_t* I_du,uint8_t* I_dv,int32_t width,int32_t height,int32_t bpl,int subsampling_step);
