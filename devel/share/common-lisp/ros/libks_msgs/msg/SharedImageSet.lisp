...
(cl:defmethod cl:initialize-instance :after ((m <SharedImageSet>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SharedImageSet)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name libks_msgs-msg:<SharedImageSet> is deprecated: use libks_msgs-msg:SharedImageSet instead.")))
...
(cl:defmethod imagePtrs-val ((m <SharedImageSet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader libks_msgs-msg:imagePtrs-val is deprecated.  Use libks_msgs-msg:imagePtrs instead.")
  (imagePtrs m))
