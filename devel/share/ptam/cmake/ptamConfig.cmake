...
if("TRUE" STREQUAL "TRUE")
  set(ptam_SOURCE_PREFIX /home/sun/catkin_ws/src/ethzasl_ptam/ptam)
  set(ptam_DEVEL_PREFIX /home/sun/catkin_ws/devel)
  set(ptam_INSTALL_PREFIX "")
  set(ptam_PREFIX ${ptam_DEVEL_PREFIX})
else()
  set(ptam_SOURCE_PREFIX "")
  set(ptam_DEVEL_PREFIX "")
  set(ptam_INSTALL_PREFIX /home/sun/catkin_ws/install)
...
if(NOT "/home/sun/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ptam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sun/catkin_ws/src/ethzasl_ptam/ptam/${idir}'.  Ask the maintainer 'Markus Achtelik <markus.achtelik@mavt.ethz.ch>, Stephan Weiss <stephan.weiss@mavt.ethz.ch>, Simon Lynen <simon.lynen@mavt.ethz.ch>' to fix it.")
    endif()
