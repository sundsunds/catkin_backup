...
if(NOT "/home/sun/catkin_ws/src/nodes/sparsestereo/src " STREQUAL " ")
  set(sparsestereo_INCLUDE_DIRS "")
  set(_include_dirs "/home/sun/catkin_ws/src/nodes/sparsestereo/src")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sparsestereo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sun/catkin_ws/src/nodes/sparsestereo/${idir}'.  Ask the maintainer 'Radouane Ait Jellal <radouane.ait-jellal@uni-tuebingen.de>' to fix it.")
    endif()
